...
void Game::gameLoop()
{
	...
	al_register_event_source(queue, al_get_keyboard_event_source());//okreœlanie sk¹d kolejka wydarzeñ ma oczekiwaæ wydarzeñ
	al_register_event_source(queue, al_get_display_event_source(display));//okreœlanie sk¹d kolejka wydarzeñ ma oczekiwaæ wydarzeñ
	al_register_event_source(queue, al_get_timer_event_source(timer));//okreœlanie sk¹d kolejka wydarzeñ ma oczekiwaæ wydarzeñ
